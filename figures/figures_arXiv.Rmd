...
ggsave("ArXiv_plots/Fig2.pdf", width = 6.75, height = 3, 
       dpi=600, units = "in")
```
...
ggsave("ArXiv_plots/Fig3.pdf", width = 6.75, height = 3, 
       dpi=600, units = "in")
```
...
ggsave("ArXiv_plots/Fig4.pdf", width = 6.75, height = 1.75,
       dpi=600, units = "in")
```
...
ggsave("ArXiv_plots/Fig5.pdf", width = 6.75, height = 3,
       dpi=600, units = "in")
```
...
ggsave("ArXiv_plots/Fig6.pdf", width = 6.75, height = 1.75,
       dpi=600, units = "in")
```
...
ggsave("ArXiv_plots/Fig7.pdf", width = 6.75, height = 1.75,
       dpi=600, units = "in")
```
...
ggsave("ArXiv_plots/Fig8.pdf", width = 6.75, height = 1.75,
       dpi=600, units = "in")
```
...
ggsave("ArXiv_plots/Fig9.pdf", width = 6.75, height = 1.75,
       dpi=600, units = "in")
```
...
ggsave("ArXiv_plots/Fig10.pdf", width = 6.75, height = 1.75,
       dpi=600, units = "in")
```
...
ggsave("ArXiv_plots/Fig11.pdf", width = 6.75, height = 1.75,
       dpi=600, units = "in")
```
...
ggsave("ArXiv_plots/Fig12.pdf", width = 6.75, height = 1.75,
       dpi=600, units = "in")
```
...
ggsave("ArXiv_plots/Fig13.pdf", width = 6.75, height = 1.75,
       dpi=600, units = "in")
```
...
ggsave("ArXiv_plots/Fig14.pdf", width = 6.75, height = 1.75,
       dpi=600, units = "in")
```
...
ggsave("ArXiv_plots/Fig15.pdf", width = 6.75, height = 1.75,
       dpi=600, units = "in")
```
...
ggsave("ArXiv_plots/Fig16.pdf", width = 6.75, height = 1.75,
       dpi=600, units = "in")
```